...
import "./TwentyMinFranchiseApplicationList.css";
...
const TwentyMinFranchiseApplicationList = () => {
  ...
  const [franchiseApplicationList, setFranchiseApplicationList] = useState([]);
  ...
  const requestSearch = (searched) => {
    setCurrentPage(0);
    let filteredData = franchiseApplicationList.filter(
      (data) =>
  ...
  const getFranchiseApplication = () => {
    PagesIndex.DataService.get(
      PagesIndex.Api.GET_20_MIN_FRANCHISE_APPLICATION_LIST
    )
      .then((res) => {
        setFranchiseApplicationList(res?.data?.data);
  ...
  const generateExcel = async () => {
    const headers = ["User", "Email", "Phone Number", "City", "Date"];
    ...
    PagesIndex.XLSX.writeFile(
      workbook,
      `Franchise_Application_List_${PagesIndex.moment().format(
            ...
            <Index.Box className="title-header">
              <Index.Box className="title-header-flex res-title-header-flex">
                <Index.Box className="title-main  common-export-flex">
                  ...
                  >
                    20 Min Franchise Application List
                  </Index.Typography>
...
export default TwentyMinFranchiseApplicationList;
